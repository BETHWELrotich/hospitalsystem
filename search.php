...
<body>
    <!-- Navigation -->
    <nav style="background-color:#333;" class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" >PERSONAL HEALTHCARE ASSISTANT</a>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    <li>
                        <a style="color:#333;" href="cover.php">Home</a>
                    </li>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="list-group">
                    ...
                    <a style="background-color:#333;" href="search.php" class="list-group-item active">Search</a>
            ...
            <div id="content" class="col-md-9">
                ...
                <form class="form-horizontal" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                    ...
                    <div class="form-group">
                        <div class="col-xs-offset-3 col-sm-offset-5 col-lg-offset-5 col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <input style="background-color:#333;" type="submit" name="sub" class="btn btn-primary" value="Submit">
                ...
                <form class="form-horizontal" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                    ...
                    <div class="form-group">
                        <div class="col-xs-offset-3 col-sm-offset-5 col-lg-offset-5 col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <input style="background-color:#333;" type="submit" class="btn btn-primary" value="Submit">
                            <input type="reset" class="btn btn-default" value="Reset">
                        </div>
                    </div>
                </form>
                <?php
                if (isset($_POST['sym'])) {
                    $sql = "SELECT * from symptoms where name in ('" . implode("','", $_POST['sym']) . "')";
                    if (!$result = $db->query($sql)) {
                        die('There was an error running the query [' . $db->error . ']');
                    }
                    $sympid = array();
                    ...
                    arsort($discal);
                    ?>
                    <h3 class="col-xs-3">Diseases</h3><h3><a href="MedicineSearch.php">Medication</a></h3>
                    <div style="height:260px;overflow:auto;" class="col-xs-12 col-sm-12 col-lg-12">
                        <table class="table table-striped">
                            <tbody>
                                <?php
