...
<h2>
  ...
  <div class="dropdown-content">
	  ...
	  <a href="addReceptionistclinic.php">Asign Receptionist to Clinic</a>
	  <a href="deletedoctorclinic.php">Delete Doctor from Clinic</a>
	  <a href="deleteReceptionistclinic.php">Delete Receptionist from Clinic</a>
	  <a href="showclinic.php">Show Clinic</a>
    </div>
  </li>
  <li class="dropdown">    
  <a href="javascript:void(0)" class="dropbtn">Receptionist</a>
  <div class="dropdown-content">
      <a href="addrecep.php">Add Receptionist</a>
      <a href="deleterecep.php">Delete Receptionist</a>
	  <a href="showrecep.php">Show Receptionist</a>
    </div>
  </li>
   <li>  
