...
<div class="container" style="width:100%">
	...
	<form method="post">
	  ...
	  <button type="button" onclick="window.location.href='search.php'" style="background-color:#2B4F76">Virtual Treatment</button>
	  <button type="submit" name="cancel" style="float:center;background-color:#2B4F76">Cancel Booking</button>
	  <button type="button" onclick="window.location.href='payment.php'" style="background-color:#2B4F76">Payment</button>
