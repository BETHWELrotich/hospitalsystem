...
<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="images/cal.png" width="30px" height="30px"><strong> Personal Healtcare Assistant </strong>Welcome to Sign up page!</a></li>
