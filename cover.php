...
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo">PERSONAL HEALTHCARE ASSISTANT</a></li>
					<li><a href="locateus.php">Locate Us</a></li>
					<li><a href="#home">Home</a></li>
				</ul>
			</div>
			<div class="center">
				<p style="text-align:center;color:black;font-size:30px;top:35%">PERSONAL HEALTHCARE ASSISTANT</p><br>
			...
			<div class="footer">
				<ul style="position:absolute;top:93%;background-color:black">
					...
					<li><a href="admin/mlogin.php">Receptionist Login</a></li>
				</ul>
			</div>
